  ...
  return (
    <div className="flex items-start gap-3 px-5 py-4 border-b border-[rgba(255,255,255,0.06)]">
      <div className="mt-0.5 flex h-7 w-7 shrink-0 items-center justify-center rounded-[8px]"
        ...
        <Icon className="h-3.5 w-3.5 text-[#ADFF2F]" />
      </div>
      <div>
        ...
        <div className="space-y-5">
            ...
            <div className="space-y-4 p-5">
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button className="flex h-9 w-9 shrink-0 items-center justify-center rounded-[10px] transition-all duration-150"
                    style={{ background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.08)" }}>
                    <ExternalLink className="h-3.5 w-3.5 text-[#8B96A0]" />
                  </button>
                </div>
              </div>
              <Button variant="primary" size="sm" className="w-full">Save changes</Button>
            </div>
          </div>
          ...
          <div className="overflow-hidden rounded-2xl" style={glass}>
            ...
            <div className="space-y-3 p-5">
              ...
              <button className="text-xs font-mono text-[#ADFF2F] hover:underline transition-opacity hover:opacity-80">
                Regenerate key →
              </button>
            </div>
          </div>
          ...
          <div className="overflow-hidden rounded-2xl" style={{ background: "rgba(248,113,113,0.04)", border: "1px solid rgba(248,113,113,0.18)", backdropFilter: "blur(20px)" }}>
            <div className="flex items-center gap-3 border-b border-[rgba(248,113,113,0.12)] px-5 py-4">
              <div className="flex h-7 w-7 shrink-0 items-center justify-center rounded-[8px]" style={{ background: "rgba(248,113,113,0.1)", border: "1px solid rgba(248,113,113,0.2)" }}>
                <Shield className="h-3.5 w-3.5 text-[#F87171]" />
              </div>
              ...
              {MEMBERS.map(({ address, role, name, color }) => (
                <div key={address} className="flex items-center justify-between gap-3 rounded-xl px-3 py-2.5 transition-colors hover:bg-[rgba(255,255,255,0.03)]">
                  ...
                  <div className="flex items-center gap-2 shrink-0">
                    ...
                    {role !== "owner" && (
                      <button className="flex h-7 w-7 items-center justify-center rounded-[8px] text-[#4B5563] hover:text-[#F87171] hover:bg-[rgba(248,113,113,0.1)] transition-all duration-150">
