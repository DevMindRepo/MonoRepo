  ...
  return (
    <section id="features" className="py-16 bg-[#070B0E]">
      <div
        ...
        style={{
          boxShadow: "0 2px 0 rgba(255,255,255,0.06) inset, 0 -1px 0 rgba(0,0,0,0.4) inset, 0 20px 60px rgba(0,0,0,0.6), 0 8px 24px rgba(0,0,0,0.4), 0 1px 0 rgba(255,255,255,0.08)",
